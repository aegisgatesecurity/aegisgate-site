...
AegisGate Platform v4.3.3+ includes a live infrastructure compliance scanner that checks your platform's runtime configuration against security best practices and maps results to NIST CSF controls.
