...
5. **Customer-facing security operations** — threat detection (216 patterns), RBAC with MFA, OIDC/SAML SSO integration, TLS 1.3 transport encryption, AES-256 encryption at rest with customer-managed keys.
...
- **Context:** Risk assessments consider AegisGate's self-hosted architecture, the shared responsibility model, and threat intelligence from the 216 detection patterns integrated into the compliance engine.
