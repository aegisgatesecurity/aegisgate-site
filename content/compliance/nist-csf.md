...
| ID.AM-02 | Asset vulnerabilities are identified and managed | Compliance engine runs 1,457 automated controls including vulnerability-oriented controls across 31 frameworks. 176 detection patterns identify exposure risks in real time (secrets, PII/PHI, prompt injection vectors, data exfiltration paths). | 3 | ✅ Implemented |
