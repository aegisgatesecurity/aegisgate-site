...
description: "Content Security Policy, on-device ML inference, Ed25519-signed commits, Apache 2.0, vulnerability disclosure policy per RFC 9116. The v0.4.1 security model."
type: "docs"
weight: 3
---
...
<strong>🛡️ AegisGate Lens v0.4.1</strong> &mdash; <em>canonical facts (source: <a href="https://github.com/aegisgatesecurity/aegisgate-lens">aegisgate-lens repo</a>)</em>
...
The full source code is on [GitHub](https://github.com/aegisgatesecurity/aegisgate-lens) (Apache 2.0). This page summarizes the security model of v0.4.1.
...
- [ML Model Card](https://github.com/aegisgatesecurity/aegisgate-lens/blob/v0.4.1/docs/MODEL-CARD.md) — architecture, evaluation, limitations, ethical considerations
- [Lens SECURITY.md on GitHub](https://github.com/aegisgatesecurity/aegisgate-lens/blob/v0.4.1/docs/SECURITY.md)
