...
description: "Content Security Policy, Ed25519-signed commits, Apache 2.0, vulnerability disclosure policy per RFC 9116. The v0.2.0 security model."
type: "docs"
weight: 3
---
...
The full source code is on [GitHub](https://github.com/aegisgatesecurity/aegisgate-lens) (Apache 2.0). This page summarizes the security model of v0.2.0.
