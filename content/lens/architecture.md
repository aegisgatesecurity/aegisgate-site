...
The full source code is on [GitHub](https://github.com/aegisgatesecurity/aegisgate-lens) (Apache 2.0). This page summarizes the architecture of v0.4.1.
...
v0.4.1 combines regex and ML for complementary coverage:
