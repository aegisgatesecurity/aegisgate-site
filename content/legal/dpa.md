...
description: "GDPR Article 28 Data Processing Agreement for AegisGate Security, LLC customers. Effective 2026-06-07. 2.0 DRAFT for v4.2.0."
type: "legal-doc"
---
...
> **First published:** 2026-06-07 (v4.2.0). **Effective:** 2026-06-07.
> **Real legal counsel review is deferred to v4.2.0+** when budget is available.
...
### 7.2 Audit Logs
Audit logs shall be retained for the period specified in the Subscriber's subscription tier (Community 7 days, Developer 30 days, Professional 90 days, Enterprise as agreed), after which they shall be deleted automatically.
