...
**Test Scope:** AegisGate Security Platform v4.2.0
...
|------|--------|-----------------|---------------|------|
| 1 | Pull container image | `docker pull ghcr.io/aegisgatesecurity/aegisgate-platform:v4.2.0` succeeds | ✅ Pulled successfully | 4 min |
...
| 12 | Verify scanner | Test detection pattern count | ✅ 216 patterns active | 10 sec |
