...
**Test Scope:** AegisGate Security Platform v3.6.2
...
|------|--------|-----------------|---------------|------|
| 1 | Pull container image | `docker pull ghcr.io/aegisgatesecurity/aegisgate-platform:v3.6.2` succeeds | ✅ Pulled successfully | 4 min |
